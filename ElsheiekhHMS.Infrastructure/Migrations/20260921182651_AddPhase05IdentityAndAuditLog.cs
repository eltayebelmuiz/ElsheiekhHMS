...
{
    /// <inheritdoc />
    public partial class AddPhase05IdentityAndAuditLog : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SecurityState = table.Column<byte>(type: "tinyint", nullable: false, defaultValue: (byte)0),
                    LoginAllowed = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                    CreatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset(7)", nullable: false),
                    DisabledAt = table.Column<DateTimeOffset>(type: "datetimeoffset(7)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActorUserId = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    ActorUserNameSnapshot = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
