...
- **generatedAtUtc:** `2026-09-23T14:10:03.0259694+00:00`
- **gitBranch:** `main`
- **gitCommit:** `c1284dec9e289c320de223acd1cf5bb655a99800`
- **workingTreeDirty:** `True`
- **sourceFingerprint:** `2eec5547d9a79256e017568e8bc41c78cb8313a3f393d45b7ba7322ab9319387`
- Framework: net10.0
...
- `ElsheiekhHMS.Application.Clinical.ProviderOwnership.Persistence.ProviderOwnershipConflictException` -> `System.Exception` — ElsheiekhHMS.Application/Clinical/ProviderOwnership/Persistence/ProviderOwnershipConflictException.cs:L3
...
- `ElsheiekhHMS.Infrastructure.Migrations.AddEncounterPersistence` -> `Microsoft.EntityFrameworkCore.Migrations.Migration` — ElsheiekhHMS.Infrastructure/Migrations/20260923140334_AddEncounterPersistence.cs:L9
...
- `ElsheiekhHMS.Infrastructure.Migrations.AddProviderOwnership` -> `Microsoft.EntityFrameworkCore.Migrations.Migration` — ElsheiekhHMS.Infrastructure/Migrations/20260923133220_AddProviderOwnership.cs:L8
...
- `ElsheiekhHMS.Infrastructure.Persistence.ElsheiekhHmsDbContext` -> `Microsoft.AspNetCore.Identity.EntityFrameworkCore.IdentityDbContext<ElsheiekhHMS.Infrastructure.Identity.Entities.ApplicationUser>` — ElsheiekhHMS.Infrastructure/Persistence/ElsheiekhHmsDbContext.cs:L14
...
- `ElsheiekhHMS.Tests.Integration.Persistence.ElsheiekhHmsDbContextSqlServerTests.FixedTimeProvider` -> `System.TimeProvider` — ElsheiekhHMS.Tests/Integration/Persistence/ElsheiekhHmsDbContextSqlServerTests.cs:L210
...
- `Microsoft.EntityFrameworkCore.IEntityTypeConfiguration<ElsheiekhHMS.Infrastructure.Auditing.Entities.AuditLog>`
  - Implementations: ElsheiekhHMS.Infrastructure.Auditing.Configurations.AuditLogConfiguration, ElsheiekhHMS.Infrastructure.Configurations.Entities.AppointmentConfiguration, ElsheiekhHMS.Infrastructure.Configurations.Entities.DepartmentConfiguration, ElsheiekhHMS.Infrastructure.Configurations.Entities.DoctorConfiguration, ElsheiekhHMS.Infrastructure.Configurations.Entities.DoctorScheduleConfiguration, ElsheiekhHMS.Infrastructure.Configurations.Entities.EncounterConfiguration, ElsheiekhHMS.Infrastructure.Configurations.Entities.PatientConfiguration, ElsheiekhHMS.Infrastructure.Configurations.Entities.WalkInQueueEntryConfiguration, ElsheiekhHMS.Infrastructure.Identity.Configurations.ApplicationUserConfiguration, ElsheiekhHMS.Infrastructure.Identity.Configurations.DoctorApplicationUserLinkConfiguration, ElsheiekhHMS.Infrastructure.Persistence.Allocation.AppointmentCodeAllocationConfiguration, ElsheiekhHMS.Infrastructure.Persistence.Allocation.PatientCodeAllocationConfiguration, ElsheiekhHMS.Infrastructure.Persistence.Allocation.QueueTicketAllocationConfiguration
...
15 classes; 116 methods; 157 statically enumerable cases. This is discovery from source, not an execution result.

- [ElsheiekhHMS.Tests.Integration.Persistence.EncounterSqlServerTests](../ElsheiekhHMS.Tests/Integration/Persistence/EncounterSqlServerTests.cs) — 15 cases
  ...
  - Uses/tests `ElsheiekhHMS.Core.Domain.Scheduling.Entities.WalkInQueueEntry` (source type/member binding; includes inherited foundation dependencies)
  - Uses/tests `ElsheiekhHMS.Core.Domain.Scheduling.Enums.QueuePriority` (source type/member binding; includes inherited foundation dependencies)
...
- [ElsheiekhHMS.Tests.Integration.Persistence.ProviderOwnershipSqlServerTests](../ElsheiekhHMS.Tests/Integration/Persistence/ProviderOwnershipSqlServerTests.cs) — 4 cases
  - Uses/tests `ElsheiekhHMS.Core.Common.AuditableEntity` (source type/member binding; includes inherited foundation dependencies)
  - Uses/tests `ElsheiekhHMS.Core.Common.BaseEntity` (source type/member binding; includes inherited foundation dependencies)
  - Uses/tests `ElsheiekhHMS.Core.Common.SoftDeletableEntity` (source type/member binding; includes inherited foundation dependencies)
  - Uses/tests `ElsheiekhHMS.Core.Domain.Organization.Entities.Department` (source type/member binding; includes inherited foundation dependencies)
  - Uses/tests `ElsheiekhHMS.Core.Domain.Staff.Entities.Doctor` (source type/member binding; includes inherited foundation dependencies)
  - Uses/tests `ElsheiekhHMS.Infrastructure.Identity.Entities.ApplicationUser` (source type/member binding; includes inherited foundation dependencies)
  - Uses/tests `ElsheiekhHMS.Infrastructure.Identity.Entities.DoctorApplicationUserLink` (source type/member binding; includes inherited foundation dependencies)
  - Uses/tests `ElsheiekhHMS.Infrastructure.Persistence.ElsheiekhHmsDbContext` (source type/member binding; includes inherited foundation dependencies)
...
- [ElsheiekhHMS.Tests.Unit.Application.Clinical.ProviderOwnershipServiceTests](../ElsheiekhHMS.Tests/Unit/Application/Clinical/ProviderOwnershipServiceTests.cs) — 15 cases
  - Uses/tests `ElsheiekhHMS.Application.Clinical.ProviderOwnership.Contracts.AssignProviderOwnershipRequest` (source type/member binding; includes inherited foundation dependencies)
  - Uses/tests `ElsheiekhHMS.Application.Clinical.ProviderOwnership.Contracts.ProviderOwnershipDto` (source type/member binding; includes inherited foundation dependencies)
  - Uses/tests `ElsheiekhHMS.Application.Clinical.ProviderOwnership.Persistence.DoctorStatusSnapshot` (source type/member binding; includes inherited foundation dependencies)
  - Uses/tests `ElsheiekhHMS.Application.Clinical.ProviderOwnership.Persistence.IProviderOwnershipPersistence` (source type/member binding; includes inherited foundation dependencies)
  - Uses/tests `ElsheiekhHMS.Application.Clinical.ProviderOwnership.Persistence.ProviderAccountStatus` (source type/member binding; includes inherited foundation dependencies)
  - Uses/tests `ElsheiekhHMS.Application.Clinical.ProviderOwnership.ProviderOwnershipService` (source type/member binding; includes inherited foundation dependencies)
  - Uses/tests `ElsheiekhHMS.Application.Common.Auditing.AuditActions` (source type/member binding; includes inherited foundation dependencies)
  ...
  - Uses/tests `ElsheiekhHMS.Application.Common.Auditing.IAuditEventWriter` (source type/member binding; includes inherited foundation dependencies)
  - Uses/tests `ElsheiekhHMS.Application.Common.Results.ServiceError` (source type/member binding; includes inherited foundation dependencies)
  - Uses/tests `ElsheiekhHMS.Application.Common.Results.ServiceResult<T>` (source type/member binding; includes inherited foundation dependencies)
  ...
  - Uses/tests `ElsheiekhHMS.Application.Common.Security.RoleNames` (source type/member binding; includes inherited foundation dependencies)
...
- Identity source references: `[
      "ElsheiekhHMS.Infrastructure/Development/DevelopmentDataSeeder.cs",
...
- > **Current development stage:** Phase13C complete — Provider ownership mapping and ownership-aware resolution foundation implemented and verified; Encounter persistence remains the next clinical gate — README.md:L5
...
- > **Phase 13B:** ✅ Encounter domain model implemented and verified in Core with focused domain tests — README.md:L98
- > **Phase 13C:** ✅ Provider ownership mapping, administrative assignment/unassignment, active-account resolution, audit events, migration, isolated SQL verification, and development mapping seed complete; clinical authoring remains deferred — README.md:L100
-  /  01  /  Solution & Architecture  /  ✅ Complete  /  — README.md:L419
-  /  02  /  Core Foundation  /  ✅ Complete  /  — README.md:L420
-  /  03  /  Domain Entities  /  ✅ Complete  /  — README.md:L421
-  /  04  /  EF Core & Database  /  ✅ Complete  /  — README.md:L422
-  /  05  /  Identity & Security  /  ✅ Complete (05A, 05B, 05C, 05C-A, 05D, and 05E)  /  — README.md:L423
-  /  06  /  DTOs & Validation  /  ✅ Complete (06A–06D)  /  — README.md:L424
-  /  07  /  Application Services  /  ✅ Complete for approved scope (07S, 07A, 07B, 07C-P, 07C, 07D; 07E deferred)  /  — README.md:L425
-  /  08  /  Business Workflows  /  ✅ Complete (08A, 08B-P, 08B)  /  — README.md:L426
-  /  09  /  Enterprise Infrastructure  /  ✅ Complete (09A, 09B)  /  — README.md:L427
...
- [ElsheiekhHMS.Application/Clinical/ProviderOwnership/Contracts/AssignProviderOwnershipRequest.cs](../ElsheiekhHMS.Application/Clinical/ProviderOwnership/Contracts/AssignProviderOwnershipRequest.cs) — ElsheiekhHMS.Application
- [ElsheiekhHMS.Application/Clinical/ProviderOwnership/Contracts/ProviderOwnershipDto.cs](../ElsheiekhHMS.Application/Clinical/ProviderOwnership/Contracts/ProviderOwnershipDto.cs) — ElsheiekhHMS.Application
- [ElsheiekhHMS.Application/Clinical/ProviderOwnership/IProviderOwnershipService.cs](../ElsheiekhHMS.Application/Clinical/ProviderOwnership/IProviderOwnershipService.cs) — ElsheiekhHMS.Application
- [ElsheiekhHMS.Application/Clinical/ProviderOwnership/Persistence/DoctorStatusSnapshot.cs](../ElsheiekhHMS.Application/Clinical/ProviderOwnership/Persistence/DoctorStatusSnapshot.cs) — ElsheiekhHMS.Application
- [ElsheiekhHMS.Application/Clinical/ProviderOwnership/Persistence/IProviderOwnershipPersistence.cs](../ElsheiekhHMS.Application/Clinical/ProviderOwnership/Persistence/IProviderOwnershipPersistence.cs) — ElsheiekhHMS.Application
- [ElsheiekhHMS.Application/Clinical/ProviderOwnership/Persistence/ProviderAccountStatus.cs](../ElsheiekhHMS.Application/Clinical/ProviderOwnership/Persistence/ProviderAccountStatus.cs) — ElsheiekhHMS.Application
- [ElsheiekhHMS.Application/Clinical/ProviderOwnership/Persistence/ProviderOwnershipConflictException.cs](../ElsheiekhHMS.Application/Clinical/ProviderOwnership/Persistence/ProviderOwnershipConflictException.cs) — ElsheiekhHMS.Application
- [ElsheiekhHMS.Application/Clinical/ProviderOwnership/ProviderOwnershipService.cs](../ElsheiekhHMS.Application/Clinical/ProviderOwnership/ProviderOwnershipService.cs) — ElsheiekhHMS.Application
...
- [ElsheiekhHMS.Infrastructure/Configurations/Entities/EncounterConfiguration.cs](../ElsheiekhHMS.Infrastructure/Configurations/Entities/EncounterConfiguration.cs) — ElsheiekhHMS.Infrastructure
...
- [ElsheiekhHMS.Infrastructure/Development/DevelopmentDataSeeder.cs](../ElsheiekhHMS.Infrastructure/Development/DevelopmentDataSeeder.cs) — ElsheiekhHMS.Infrastructure
...
- [ElsheiekhHMS.Infrastructure/Identity/Configurations/DoctorApplicationUserLinkConfiguration.cs](../ElsheiekhHMS.Infrastructure/Identity/Configurations/DoctorApplicationUserLinkConfiguration.cs) — ElsheiekhHMS.Infrastructure
...
- [ElsheiekhHMS.Infrastructure/Identity/Entities/DoctorApplicationUserLink.cs](../ElsheiekhHMS.Infrastructure/Identity/Entities/DoctorApplicationUserLink.cs) — ElsheiekhHMS.Infrastructure
...
- [ElsheiekhHMS.Infrastructure/Identity/ProviderOwnershipPersistence.cs](../ElsheiekhHMS.Infrastructure/Identity/ProviderOwnershipPersistence.cs) — ElsheiekhHMS.Infrastructure
...
- [ElsheiekhHMS.Infrastructure/Migrations/20260923133220_AddProviderOwnership.Designer.cs](../ElsheiekhHMS.Infrastructure/Migrations/20260923133220_AddProviderOwnership.Designer.cs) — ElsheiekhHMS.Infrastructure
- [ElsheiekhHMS.Infrastructure/Migrations/20260923133220_AddProviderOwnership.cs](../ElsheiekhHMS.Infrastructure/Migrations/20260923133220_AddProviderOwnership.cs) — ElsheiekhHMS.Infrastructure
- [ElsheiekhHMS.Infrastructure/Migrations/20260923140334_AddEncounterPersistence.Designer.cs](../ElsheiekhHMS.Infrastructure/Migrations/20260923140334_AddEncounterPersistence.Designer.cs) — ElsheiekhHMS.Infrastructure
- [ElsheiekhHMS.Infrastructure/Migrations/20260923140334_AddEncounterPersistence.cs](../ElsheiekhHMS.Infrastructure/Migrations/20260923140334_AddEncounterPersistence.cs) — ElsheiekhHMS.Infrastructure
...
- [ElsheiekhHMS.Tests/Integration/Persistence/EncounterSqlServerTests.cs](../ElsheiekhHMS.Tests/Integration/Persistence/EncounterSqlServerTests.cs) — ElsheiekhHMS.Tests
...
- [ElsheiekhHMS.Tests/Integration/Persistence/ProviderOwnershipSqlServerTests.cs](../ElsheiekhHMS.Tests/Integration/Persistence/ProviderOwnershipSqlServerTests.cs) — ElsheiekhHMS.Tests
...
- [ElsheiekhHMS.Tests/Unit/Application/Clinical/ProviderOwnershipServiceTests.cs](../ElsheiekhHMS.Tests/Unit/Application/Clinical/ProviderOwnershipServiceTests.cs) — ElsheiekhHMS.Tests
